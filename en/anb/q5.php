    ...
    <div class="question">
        <div class="container">
            ...
            <form action="q1.php" method="POST" name="form">
                ...
                <div class="option">
                    <label for="">
                        <input type="checkbox" name="option_anb" value="Adiós">
                        <span>Adiós</span>
                    </label>
                </div>
                <div class="option">
                    <label for="">
                        <input type="checkbox" name="option_anb" value="Hola">
                        <span>Hola</span>
                    </label>
                </div>
                <div class="option">
                    <label for="">
                        <input type="checkbox" name="option_anb" value="Me gusta">
                        <span>Me gusta</span>
                    </label>
                </div>
                <div class="option">
                    <label for="">
                        <input type="checkbox" name="option_anb" value="Perfecto">
                        <span>Perfecto</span>
                    </label>
                </div>
